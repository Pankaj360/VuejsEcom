    ...
    <div class="productForm">
        <form id="productCU" @submit="actionProduct" v-if="!loading">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="productDescription" v-model="product.productDescription" placeholder="Enter Description">
              </div>

              <div class="form-group">
                <label for="productPrice">Product Price</label>
                <input type="text" class="form-control" id="productPrice" v-model="product.productPrice" placeholder="Enter Price">
              </div>

              <div class="form-group">
                <label for="Inventory">Product Inventory Number</label>
                <input type="text" class="form-control" id="Inventory" v-model="product.Inventory" placeholder="Inventory Number">
              </div>
